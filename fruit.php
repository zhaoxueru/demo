 ...
 *
 * 2. Visit http://host_address/api.php?cmd=fruit/fruit&color=yellow&smell=sweet
 * 3. Visit http://host_address/api.php?cmd=fruit/fruit&color=yellow&smell=sweet&shape=pear
 *
 ...
 *
 * http://host_address/api.php?cmd=fruit/fruit-color-smell-guess&color=yellow&smell=sweet
 * http://host_address/api.php?cmd=fruit/fruit-color-smell-shape-guess&color=yellow&smell=sweet&shape=pear
 *
 * In CLI mode, you can input as follows:
 *
 * php api.php -r result -c "fruit/fruit" -d "color=yellow&smell=sweet&shape=pear"
 * php api.php -r result -l -c "fruit/fruit" -d "color=yellow&smell=sweet&shape=pear"
 * php api.php -r result -l -c "fruit/fruit-color-smell-shape-guess" -d "color=yellow&smell=sweet&shape=pear"
 *
 * or, any kind of these. Just see the comment in /core/ctr/router/cli.php, begin from line 76 to 81
 *
